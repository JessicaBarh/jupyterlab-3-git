...
var DiffStatus;
(function (DiffStatus) {
    DiffStatus[DiffStatus["Equal"] = DIFF_EQUAL] = "Equal";
    DiffStatus[DiffStatus["Delete"] = DIFF_DELETE] = "Delete";
    DiffStatus[DiffStatus["Insert"] = DIFF_INSERT] = "Insert";
...
class DiffView {
    ...
    init(pane, orig, options) {
        ...
        this.orig = CodeMirror(pane, Object.assign(Object.assign({}, options), { value: orig, readOnly: !this.mv.options.allowEditingOriginals }));
 ...
 */
export function mergeView(node, options) {
...
class MergeView {
    constructor(node, options) {
        ...
        this.edit = CodeMirror(editPane, Object.assign({}, options));
        // Add gutter
